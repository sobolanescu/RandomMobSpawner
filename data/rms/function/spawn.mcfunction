...
execute as @a[scores={random_mob_timer=200..}] run function rms:spawn_random_mob
...
execute as @a[scores={random_mob_timer=201..}] run scoreboard players set @a random_mob_timer 0
...
execute as @a[scores={random_mob_timer=0}] run scoreboard players set @s countdown 11
